...
- `codex-rs/tui` is the active TUI implementation. Treat lingering `codex-rs/tui_app_server` references as compatibility-era leftovers unless a task explicitly targets migration cleanup.

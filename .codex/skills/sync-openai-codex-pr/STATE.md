...
- notes: 同步 openai/codex main (7bbe3b6..824ec94)，合并 20 个上游提交；保留本地 ztok/ztldr/zmemory、buddy 事件与中文化文案，同时吸收上游 marketplace、guardian review source、exec-server ownership、hooks 渲染重构等改动。

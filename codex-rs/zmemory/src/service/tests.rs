...
fn search_snippet_preserves_multibyte_boundaries() {
    ...
    execute_action(
        ...
        &ZmemoryToolCallParam {
            ...
            content: Some(format!(
                "\u{524d}\u{7f00}{}GraphService\u{540e}\u{7f00}",
                "\u{91cf}".repeat(40)
            )),
            ..ZmemoryToolCallParam::default()
        },
    ...
    let literal_snippet = literal["result"]["matches"][0]["snippet"]
        .as_str()
        .expect("literal snippet should exist");
    assert!(literal_snippet.contains("GraphService\u{540e}\u{7f00}"));
}
...
fn glossary_add_and_remove_refresh_search_contract() {
    ...
    execute_action(
        ...
        &ZmemoryToolCallParam {
            ...
            content: Some("\u{8d85}\u{5bfc}\u{91cf}\u{5b50}\u{7cfb}\u{7edf}\u{6bd4}\u{7279}\u{63a7}\u{5236}\u{4e0e}\u{534f}\u{4f5c}".to_string()),
            ..ZmemoryToolCallParam::default()
        },
    )
    .expect("create should succeed");
    ...
    let before_add = execute_action(
        ...
        &ZmemoryToolCallParam {
            action: ZmemoryToolAction::Search,
            query: Some("\u{5b50}\u{7cfb}\u{7edf}\u{6bd4}".to_string()),
            ..ZmemoryToolCallParam::default()
        },
    )
    .expect("search should succeed");
    ...
    execute_action(
        ...
        &ZmemoryToolCallParam {
            action: ZmemoryToolAction::ManageTriggers,
            uri: Some("core://anchor_refresh_contract".to_string()),
            add: Some(vec!["\u{5b50}\u{7cfb}\u{7edf}\u{6bd4}".to_string()]),
            ..ZmemoryToolCallParam::default()
        },
    )
    ...
    execute_action(
        ...
        &ZmemoryToolCallParam {
            action: ZmemoryToolAction::ManageTriggers,
            uri: Some("core://anchor_refresh_contract".to_string()),
            remove: Some(vec!["\u{5b50}\u{7cfb}\u{7edf}\u{6bd4}".to_string()]),
            ..ZmemoryToolCallParam::default()
        },
    )
...
fn search_uses_token_boundaries_instead_of_raw_cjk_substrings() {
    ...
    execute_action(
        ...
        &ZmemoryToolCallParam {
            ...
            content: Some("\u{8d85}\u{5bfc}\u{91cf}\u{5b50}\u{7cfb}\u{7edf}\u{6bd4}\u{7279}\u{63a7}\u{5236}\u{4e0e}\u{91cf}\u{5b50}\u{6bd4}\u{7279}\u{534f}\u{4f5c}".to_string()),
            ..ZmemoryToolCallParam::default()
        },
    )
    .expect("create should succeed");
    execute_action(
        ...
        &ZmemoryToolCallParam {
            action: ZmemoryToolAction::ManageTriggers,
            uri: Some("core://cjk_search".to_string()),
            add: Some(vec!["\u{91cf}\u{5b50}\u{6bd4}\u{7279}".to_string()]),
            ..ZmemoryToolCallParam::default()
        },
    )
    .expect("manage triggers should succeed");
    ...
    let hit = execute_action(
        ...
        &ZmemoryToolCallParam {
            action: ZmemoryToolAction::Search,
            query: Some("\u{91cf}\u{5b50}\u{6bd4}\u{7279}".to_string()),
            ..ZmemoryToolCallParam::default()
        },
    )

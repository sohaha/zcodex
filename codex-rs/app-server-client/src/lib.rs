...
pub mod legacy_core {
    ...
    pub use codex_core::DEFAULT_AGENTS_MD_FILENAME as DEFAULT_PROJECT_DOC_FILENAME;
    pub use codex_core::INTERACTIVE_SESSION_SOURCES;
    pub use codex_core::LOCAL_AGENTS_MD_FILENAME;
    pub use codex_core::LOCAL_AGENTS_MD_FILENAME as LOCAL_PROJECT_DOC_FILENAME;

...
const PAID_TOOLTIP: &str = "*新功能* 试用 **Codex App**，享受 2 倍速率限制，有效期至 *4月2日*。运行 'codex app' 或访问 https://chatgpt.com/codex?app-landing-page=true";
const PAID_TOOLTIP_WINDOWS: &str = "*新功能* 试用 **Codex App**，现已支持 **Windows**，享受 2 倍速率限制，有效期至 *4月2日*。运行 'codex app' 或访问 https://chatgpt.com/codex?app-landing-page=true";
const PAID_TOOLTIP_NON_MAC: &str = "*新功能* 2 倍速率限制，有效期至 *4月2日*。";

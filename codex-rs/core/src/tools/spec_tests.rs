...
fn rtk_and_tldr_tools_are_available_in_subagents() {
    ...
    assert!(registry.has_handler("rtk_json", None));
    assert!(registry.has_handler("rtk_deps", None));
    assert!(registry.has_handler("rtk_log", None));
    assert!(registry.has_handler("rtk_ls", None));
    assert!(registry.has_handler("rtk_tree", None));
    assert!(registry.has_handler("rtk_wc", None));
    assert!(registry.has_handler("rtk_git_status", None));
    assert!(registry.has_handler("rtk_git_diff", None));
    assert!(registry.has_handler("rtk_git_show", None));
    assert!(registry.has_handler("rtk_git_log", None));
    assert!(registry.has_handler("rtk_git_branch", None));
    assert!(registry.has_handler("rtk_git_stash", None));
    assert!(registry.has_handler("rtk_git_worktree", None));

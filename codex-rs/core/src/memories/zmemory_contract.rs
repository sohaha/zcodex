...
pub(crate) fn stable_preference_contract_markdown() -> String {
    ...
    format!(
        "- Treat explicit, durable identity, preference, or collaboration facts as long-term memory.\n\
         ...
         - If the input is clearly about assistant identity, user identity or preferences, or the collaboration contract, read the matching canonical URI before answering and do not ask the user which path to use.\n\
